/**
 * 3D Simplex noise — GLSL 3 implementation.
 * Author: Stefan Gustavson (public domain).
 *
 * Kept here for reference. The active terrain shader uses perlinNoiseGLSL
 * (classic Perlin) so that GPU and CPU produce identical output.
 *
 * Exposes:
 *   float snoise(vec3 v)  — output approximately in [-1, 1]
 */
