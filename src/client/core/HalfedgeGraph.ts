// THIS CODE WAS TAKEN FROM THE LOKI LIBRARY
// The Halfedge Data Structure re-implementation
// was needed to change Arrays to Maps for performance reasons
...
import { flipEdge } from './operations/flipEdge';
...
export class HalfedgeGraph {
  ...
  /** @readonly Halfedges */
  readonly halfedges = new Map<string, Halfedge>();
  ...
  /**
   * Flips the given halfedge and returns the new halfedge
   * This is only valid for two triangular faces sharing the halfedge
   * @param halfedge Halfedge to flip
   * @returns the new halfedge or undefined if flip not possible
   */
