 ...
 */
function getUnassignedTiles(plate: Plate): Tile[] {
 ...
 */
function assignAncientOrogenyZones(tectonicSystem: TectonicSystem): void {
  let totalZones = 0;
 ...
 * 2. Ancient orogeny zones (remnants of former mountain belts)
 */
